...
class newGameForm (forms.Form):
	redPlayer1 = forms.CharField (label= 'Red Captain', max_length = 100, initial = "", required = True) #required
	redPlayer2 = forms.CharField (label= 'Red Player 2', max_length = 100, initial = "", required = False) #required
	...
	redPlayer10 = forms.CharField (label= 'Red Goalie', max_length = 100, initial = "", required = True)

	bluePlayer1 = forms.CharField (label= 'Blue Captain', max_length = 100, initial = "", required = True) #required
	bluePlayer2 = forms.CharField (label= 'Blue Player 2', max_length = 100, initial = "", required = False) #required
	...
	bluePlayer10 = forms.CharField (label= 'Blue Goalie', max_length = 100, initial = "", required = True)
